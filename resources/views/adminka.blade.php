...
<div class="container">
    <a href="{{url('en/admin_logout')}}" class="btn btn-info btn-lg" style="float: right;margin: 20px">Log Out</a>
    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="float:left">Add user</button><br/><br/>
    <br>
    <br>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body" >
                    {{--First Name <br>--}}
                    <input type="test" placeholder="first name" class="first_name form-control" required >
                    <br>
                    <input type="test" placeholder="last name"  class="last_name form-control" required >
                    <br>
                    ...
                    <br>
                    <input type="password" placeholder="password" required  class="password form-control">
                    <br>
                </div>
