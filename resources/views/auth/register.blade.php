        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo '/' . $language ?>/register">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control datepickerrrr" name="birthday" value="{{ old('birthday') }}" required>
